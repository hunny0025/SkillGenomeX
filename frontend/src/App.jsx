...
function App() {
    ...
    const [context, setContext] = useState({
        ...
        infrastructure_access: 'High',
        digital_access: 'Regular'
    });

    const [signals, setSignals] = useState({
        creation_output: 50,
        learning_behavior: 50,
    ...
    // Fetch national stats on load
    useEffect(() => {
        fetchNationalStats();
    }, []);

    // Auto prediction when inputs change (debounced)
    useEffect(() => {
                            ...
                            >
                                ...
                                {prediction?.growth && (
                                    <div className="bg-panel border border-gray-800 p-4 rounded-lg">
                                        <h3 className="text-sm font-bold uppercase text-muted mb-2">
                                            Growth Intelligence
                                        </h3>
                                        ...
                                        <div className="grid grid-cols-3 gap-4 text-center">
                                            ...
                                            <div className="p-3 bg-gray-900 rounded">
                                                ...
                                                <div className="text-xl font-bold text-accent">
                                                    {prediction?.growth?.learning_momentum || 0}
                                                </div>
                                            </div>
                                            ...
                                            <div className="p-3 bg-gray-900 rounded">
                                                ...
                                                <div className="text-lg font-bold text-white">
                                                    {prediction?.growth?.growth_potential || 'Unknown'}
                                                </div>
                                            </div>
